...
export function GuideHeader() {
  return (
    ...
    <span style={sx("width:30px;height:30px;border:1px dashed #B6BEB7;border-radius:7px;display:grid;place-items:center;font:500 9px/1 'IBM Plex Mono',monospace;color:#616961")}>MK</span>
