...
export function RecipeSection() {
  return (
    ...
    <span style={sx("font-size:14.5px;line-height:1.58;color:#5A625C")}>Seamless stat grid (labeled illustrative), then segment cards with stat footers.</span>
    </div>
    <div className="mkstack" style={sx("border:1px solid #DDE2DC;border-radius:12px;padding:20px 22px;display:grid;grid-template-columns:52px minmax(180px,1.1fr) minmax(240px,1.8fr);gap:16px 28px;align-items:center")}>
    ...
    <span>Illustrative figures labeled as illustrative</span>
