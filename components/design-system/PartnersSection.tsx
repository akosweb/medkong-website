...
export function PartnersSection() {
  return (
    ...
    <span style={sx("display:flex;flex-direction:column;gap:8px;align-items:center")}><img src={AKOS_MARK} alt="AKOS" style={sx("width:52px;height:52px;border-radius:7px")} /><span style={sx("font:400 10.5px/1 'IBM Plex Mono',monospace;color:#6B736C")}>52px</span></span>
    <span style={sx("display:flex;flex-direction:column;gap:8px;align-items:center")}><img src={AKOS_MARK} alt="AKOS" style={sx("width:36px;height:36px;border-radius:5px")} /><span style={sx("font:400 10.5px/1 'IBM Plex Mono',monospace;color:#6B736C")}>36px</span></span>
    <span style={sx("display:flex;flex-direction:column;gap:8px;align-items:center")}><img src={AKOS_MARK} alt="AKOS" style={sx("width:20px;height:20px;border-radius:3px")} /><span style={sx("font:400 10.5px/1 'IBM Plex Mono',monospace;color:#6B736C")}>20px</span></span>
    </div>
    ...
    <div style={sx("display:flex;flex-wrap:wrap;align-items:flex-end;gap:24px;margin-top:22px")}>
    <span style={sx("display:flex;flex-direction:column;gap:8px;align-items:center")}><img src={PALANTIR_WORDMARK} alt="Palantir" style={sx("height:30px;width:auto")} /><span style={sx("font:400 10.5px/1 'IBM Plex Mono',monospace;color:#6B736C")}>30px tall</span></span>
    <span style={sx("display:flex;flex-direction:column;gap:8px;align-items:center")}><img src={PALANTIR_WORDMARK} alt="Palantir" style={sx("height:22px;width:auto")} /><span style={sx("font:400 10.5px/1 'IBM Plex Mono',monospace;color:#6B736C")}>22px</span></span>
    <span style={sx("display:flex;flex-direction:column;gap:8px;align-items:center")}><img src={PALANTIR_WORDMARK} alt="Palantir" style={sx("height:15px;width:auto")} /><span style={sx("font:400 10.5px/1 'IBM Plex Mono',monospace;color:#6B736C")}>15px</span></span>
    </div>
    ...
    <span style={sx("display:inline-flex;align-items:center;gap:10px;padding:12px 14px;background:#F7F9F7;border:1px solid #EEF1ED;border-radius:10px;font-weight:600;font-size:14.5px")}><img src={PALANTIR_WORDMARK} alt="Palantir" style={sx("height:20px;width:auto")} />Built on Foundry</span>
    <span style={sx("display:inline-flex;align-items:center;gap:10px;padding:12px 14px;background:#0A5A4B;border-radius:10px;color:#fff;font-weight:600;font-size:14.5px")}><span style={sx("background:#fff;border-radius:5px;padding:5px 9px;display:inline-flex")}><img src={PALANTIR_WORDMARK} alt="Palantir" style={sx("height:13px;width:auto")} /></span>Built on Foundry</span>
    </div>
    </div>
    </div>
