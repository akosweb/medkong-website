...
export function PartnerStrip() {
  return (
    <section style={sx("background:#F4F6F3;border-top:1px solid #E6EAE5;border-bottom:1px solid #E6EAE5;margin-top:56px;padding:44px 0")}>
    ...
    <span style={sx("display:inline-flex;align-items:center;gap:12px")}><img src={AKOS_MARK} alt="AKOS" style={sx("width:36px;height:36px;border-radius:5px")} /><span style={sx("font-weight:600;font-size:16px")}>Built by AKOS</span></span>
    <span style={sx("width:1px;height:34px;background:#D6DBD6")}></span>
    <span style={sx("display:inline-flex;align-items:center;gap:12px")}><img src={PALANTIR_WORDMARK} alt="Palantir" style={sx("height:24px;width:auto")} /><span style={sx("font-weight:600;font-size:16px")}>Built on Foundry</span></span>
