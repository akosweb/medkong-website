...
/**
 * The 44px grey trust band that follows every hero: AKOS mark, Palantir
 * wordmark, one infrastructure claim and three outlined chips. Both marks are
 * required above the fold on every page.
 */
export function TrustBand({
  claim,
  chips = ['Ontology-driven', 'Audit trail per action', 'Human in the loop'],
  afterHero = false,
}: TrustBandProps) {
  return (
    <section
